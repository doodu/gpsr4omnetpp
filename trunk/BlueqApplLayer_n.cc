...
Register_ModuleInterface(BlueqApplLayer)

//// Sample code:
// class BlueqApplLayer : public cSimpleModule
// {
//     Module_Class_Members(BlueqApplLayer,cSimpleModule,16384)
