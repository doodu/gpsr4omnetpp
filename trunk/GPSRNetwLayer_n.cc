...
ModuleInterface(GPSRNetwLayer)
    // parameters:
    Parameter(debug, ParType_Numeric ParType_Const)
    ...
    // gates:
    Gate(uppergateIn, GateDir_Input)
    Gate(uppergateOut, GateDir_Output)
    Gate(upperControlOut, GateDir_Output)
    Gate(lowerControlIn, GateDir_Input)
    Gate(lowergateIn, GateDir_Input)
    Gate(lowergateOut, GateDir_Output)
EndInterface

Register_ModuleInterface(GPSRNetwLayer)

//// Sample code:
// class GPSRNetwLayer : public cSimpleModule
// {
//     Module_Class_Members(GPSRNetwLayer,cSimpleModule,16384)
